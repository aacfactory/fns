...
func NewEndpoint(name []byte, internal bool, document documents.Endpoint, client transports.Client, signature signatures.Signature) services.Endpoint {
	return &Endpoint{
...
func (endpoint *Endpoint) Functions() (functions services.Fns) {
	//TODO implement me
	panic("implement me")
}
...
func (endpoint *Endpoint) Document() (document documents.Endpoint) {
